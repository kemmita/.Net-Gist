1. First in the root of your project, create a new class.
```cs
using System;
using System.Collections.Generic;
using System.Linq;
using System.Web;
using APILegacy.Models;

namespace APILegacy
{
    public static class DbSeeder
    {
        public static void SeedDbContext(this ApplicationDbContext db)
        {
            ...
            db.BookAuthors.AddRange(booksAuthors);
            db.SaveChanges();
        }
    }
}
```
2. To run the seed, go into Global.asax.cs andcall the statis method created above,
```cs
    public class WebApiApplication : System.Web.HttpApplication
    {
        protected void Application_Start()
        {
            ...
            DbSeeder.SeedDbContext(new ApplicationDbContext());
        }
    }
```
